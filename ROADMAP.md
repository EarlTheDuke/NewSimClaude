...
| **C** | GDP growth & scaling (economy compounds; money-creation fork returns) | **C1 (credit) COMPLETE** + **C2 VERIFIED** (GDP plateaus in the closed economy) + **C4 path (a) BUILT & VERIFIED (2026-06-09)** — a conserving Port (slices a1–a6, flag-gated, bench-frozen): outside demand lifts GDP +25–45% while its finite reserve funds it, and the lift **outlives the battery** (the export boom finances a ~2× town whose own demand holds GDP above the plateau). Bounded by the battery, conservation intact to the cent. **Path (b) bounded money creation is IN FLIGHT (user-greenlit 2026-06-09)** — the deliberate, audited relaxation for *unbounded* growth | `INITIATIVE-04-C4-MONEY-FORK.md` |
