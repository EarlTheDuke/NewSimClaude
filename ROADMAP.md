...
| **C** | GDP growth & scaling (economy compounds; money-creation fork returns) | **PLANNED** (building C1: credit & finance) — resumes phases 18–21 | `INITIATIVE-04-GDP-GROWTH.md` + `PHASE18-CREDIT.md` |
