...
- **12d — GDP = Consumption + Investment + UI.** Extend `MacroSystem` to include investment spending; surface capital/investment/GDP-breakdown in the macro panel + inspector. Test: a staffed multi-year soak shows GDP climbing then flattening.
